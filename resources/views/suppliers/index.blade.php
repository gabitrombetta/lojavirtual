<x-app-layout>
    ...
    <div class="py-4 px-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            {{-- Formulário de busca --}}
            <form action="{{ url('/suppliers') }}" method="GET" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                ...
                <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100">{{ $supplier->type }}</td>
                            <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100 space-x-2">
                                <div class="flex gap-3">
                                    ...
                                    <form action="{{ url('suppliers/delete', ['id' => $supplier->id]) }}" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este fornecedor? ')">
                                        @csrf
                                        @method('DELETE')
